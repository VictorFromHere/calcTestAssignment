...
public class Main {
    public static void main(String[] args) {
        ...
        int exAlert;
//        *** Exception processing = обработка user input ***
        ...
        if ((userInput.contains("I")) || (userInput.contains("V")) || (userInput.contains("X"))) {
            ...
            if (userInput.contains("+")) {
                ...
                for (int i = 0; i < numbs.length; i++) {
                    ...
                    if (numbs[i].equals("II")) {
                        arabNum[i] = 2;
                    }

                    if (numbs[i].equals("III")) {
                        arabNum[i] = 3;
                    }

                    if (numbs[i].equals("IV")) {
                        arabNum[i] = 4;
                    }
                    if (numbs[i].equals("V")) {
                        arabNum[i] = 5;
                    ...
                    if (numbs[i].equals("VI")) {
                        arabNum[i] = 6;
                    }

                    if (numbs[i].equals("VII")) {
                        arabNum[i] = 7;
                    }

                    if (numbs[i].equals("VIII")) {
                        arabNum[i] = 8;
                    }

                    if (numbs[i].equals("IX")) {
                        arabNum[i] = 9;
                    }
...
//                  **** Результат умножения -
                if ((arabNum[0] * arabNum[1])%10 == 0) {
                    if (arabNum[0] * arabNum[1] == 100) {
                        System.out.println(tens[(arabNum[0] * arabNum[1]) / 10]);
                    } else {
                        System.out.println(tens[(arabNum[0] * arabNum[1]) / 10 - 1]);
                    }
                    } else {
